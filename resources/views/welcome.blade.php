    ...
    <div class="col-lg-4 col-md-4 offset-lg-4 offset-md-4 mt-4 py-4 headers" style="height: 120vh;">
        <div class="d-flex justify-content-between py-4 headercontent">
            ...
            <div class="d-flex flex-sm-column flex-md-row">
                <span class="mt-4"><a href="{{ url('/login') }}" class="text-decoration-none text-white" style="border:1px solid #ebc03c; font-size: 15px"><i class="fas fa-lock"></i> အကောင့်ဝင်ပါ</a></span>
        ...
        <div style="padding-bottom: 100px;">
            ...
            <div class="d-flex justify-content-around mt-4">
                <div>
                    <div class="buttons">
                        <a href="{{ url('/index') }}" class="text-decoration-none" style="font-size: 14px;">Football</a>
                    </div>

                </div>
                <div>
                    <div class="button">
                        <a href="#"><img class="buttons-img" src="https://play-lh.googleusercontent.com/_8W1DzUsigdywIFKmm8sYIuJN6cHjzg7SOMhHC6T5MHaMl40h66ru_lAABR7eCCCKQ=w526-h296-rw" alt="" /></a>
                    </div>
            ...
            <div class="d-flex justify-content-around mt-4">
                <div>
                    <div class="button">
                        <a href="#"><img class="w-100 buttons-img" src="https://play-lh.googleusercontent.com/_8W1DzUsigdywIFKmm8sYIuJN6cHjzg7SOMhHC6T5MHaMl40h66ru_lAABR7eCCCKQ=w526-h296-rw" alt="" /></a>
                    </div>
