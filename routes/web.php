...
//football 
Route::get('/index', [App\Http\Controllers\User\WelcomeController::class, 'footballIndex']);
...
//football
Route::get('/livescore-football','FootballController@Livescore');
Route::get('/getodds','FootballController@GetOdds');
